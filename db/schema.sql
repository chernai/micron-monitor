-- Micron Monitor database schema
...
CREATE TABLE IF NOT EXISTS observations (
    ...
    value           REAL,               -- numeric value if this is a numeric observation
...
CREATE TABLE IF NOT EXISTS component_scores (
    ...
    score           REAL,               -- 0-100, NULL if insufficient data
...
CREATE TABLE IF NOT EXISTS overall_scores (
    ...
    fundamental_score   REAL,           -- weighted avg of hbm/dram/margins/capex (renormalized if any missing)
    valuation_score      REAL,          -- price attractiveness score
    overall_score       REAL,           -- for trend charting; blends fundamental+valuation per weights
